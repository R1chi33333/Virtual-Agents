...
### 2.2 Rapport vs. Emotional Connectedness. 
...
- Emotional Connectedness: Measured via the Artificial Social Agent Questionnaire (ASAQ) adapted for connectedness, also on 7-point scales.
The ASAQ asks about users’ perceived closeness and willingness to interact with the agent.
These instruments have been previously validated (e.g., HARQ for rapport). Both measures are administered immediately after each of the four scenes.
